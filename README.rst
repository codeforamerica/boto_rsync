...
::
    ...
    boto-rsync3 [OPTIONS] SOURCE DESTINATION
...
::
    ...
    boto-rsync3 [OPTIONS] /local/path/ s3://bucketname/remote/path/

or::

    boto-rsync3 [OPTIONS] gs://bucketname/remote/path/or/key /local/path/

or::

    boto-rsync3 [OPTIONS] s3://bucketname/ s3://another_bucket/
